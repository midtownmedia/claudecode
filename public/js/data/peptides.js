...
export const PEPTIDES = [
  {
    ...
    strengthUnit: 'mg',
    vialCapacityMl: 5,
    // Max dilution: at 3 mL the ladder is tidier, but a 0.5 mg starting dose
    // lands on 2.5 units, which cannot be measured. Readability of the first
    // dose wins over tidiness of the later ones.
    defaultDiluentMl: 5,
    defaultFrequency: 'qw',
    pricing: { vialPrice: 200, strength: 60, verified: true },
    dosing: { unit: 'mg', typicalLow: 0.5, typicalHigh: 8, redline: 12, minDaysBetweenIncreases: 28, label: 'Retatrutide' },
    highRisk: true,
    firstDose: {
      recommended: 0.5,
      recommendedMax: 0.5,
      max: 1,
      note: 'Start at 0.5 mg to see how you tolerate it. A first dose must never exceed 1 mg.',
    },
    ladder: [
    ...
    notes: [
      ...
      'Start at 0.5 mg to gauge tolerance. A first dose should never exceed 1 mg, whatever a sheet says.',
      'Reconstitute a 60 mg bottle with the full 5 mL of bac water. That puts 0.5 mg on roughly 4 units, which is the smallest starting dose this bottle can measure - draw it on a 0.3 mL / 30 unit syringe where the marks are widest. Less water makes the starting dose unreadable.',
  ...
  },
  {
    ...
    defaultDiluentMl: 3,
    defaultFrequency: 'qd',
    pricing: { vialPrice: 230, strength: 50, verified: true },
    ...
    notes: [
      ...
      'Sheet and bottle agree at 50 mg: the sheet stated both the unit counts and the resulting mg, and 30 units = 5 mg only works out at 50 mg in 3 mL. This one has not drifted.',
    ],
