  ...
  return el('section', { class: 'view' },
    ...
    el('div', { class: 'card' },
      ...
      el('p', { class: 'muted' },
        ...
        'Bacteriostatic water is the diluent you add to dissolve it, measured in mL. ' +
        'Units are neither — they are just the marks on the syringe you measure a dose with.'),
      el('ul', { class: 'notes' },
        el('li', {}, el('strong', {}, BAC_WATER.label), ` (${BAC_WATER.detail}) — ${BAC_WATER.note}`),
        el('li', {}, el('strong', {}, STERILE_WATER_CAUTION.label), ` — ${STERILE_WATER_CAUTION.note}`))),
